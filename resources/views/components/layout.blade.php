        ...
        <nav class="flex max-w-5xl w-full text-lg items-center py-3 px-4 lg:px-0">
            <div class="flex flex-1 gap-4">
                ...
                <ul class="flex gap-1">
                    ...
                    <x-nav-link href="/products" class="{{ request()->is('products') ? 'bg-red-500/80 hover:bg-red-500/90 text-white' : ''}} py-1 px-4 transition-colors rounded-full">Products</x-nav-link>
